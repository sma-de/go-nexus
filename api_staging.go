...
// Vendor
func (r ApiDelete3Request) ComposerVendor(composerVendor string) ApiDelete3Request {
	r.composerVendor = &composerVendor
	return r
}

// Package
func (r ApiDelete3Request) ComposerPackage(composerPackage string) ApiDelete3Request {
	r.composerPackage = &composerPackage
	return r
}

// Version
func (r ApiDelete3Request) ComposerVersion(composerVersion string) ApiDelete3Request {
...
func (a *StagingAPIService) Delete3Execute(r ApiDelete3Request) (*http.Response, error) {
	...
	if r.composerVendor != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "composer.vendor", r.composerVendor, "", "")
	}
	if r.composerPackage != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "composer.package", r.composerPackage, "", "")
	}
	if r.composerVersion != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "composer.version", r.composerVersion, "", "")
	}
